package com.nanda.aplikasiquran.viewmodel
...
import com.nanda.aplikasiquran.model.response.ModelResultNearby
import com.nanda.aplikasiquran.networking.ApiInterface
import com.nanda.aplikasiquran.networking.ApiMaps
...
class MasjidViewModel : ViewModel() {
    ...
    var strApiKey = "AIzaSyAM4Gi90NN8r4c8-kLzE2_QsUvbPZ_AePs"
